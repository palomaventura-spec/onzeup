...
export default async function AdminPlayers(){
 ...
 return <><div className="page-head"><div><h1>ONZE Players</h1><p className="muted">Perfis esportivos, planos e responsáveis.</p></div><span className="badge">{players.length} perfis</span></div>
