  ...
  return (
    <main className="product-landing player-product-landing">
      ...
      <section className="club-commercial-section dark" id="faq-player">
        ...
        <h2>Antes de criar o Player.</h2>
        <div className="club-faq">
          <article><h3>O atleta precisa estar em um clube?</h3><p>Não. Qualquer atleta pode criar seu perfil, inclusive quem está sem clube no momento.</p></article>
          <article><h3>Já estou cadastrado por um clube ONZEUP. O que faço?</h3><p>Crie a conta do responsável com o mesmo e-mail informado ao clube. Depois use “Buscar vínculos com clubes” e aguarde a confirmação da equipe.</p></article>
          <article><h3>Posso ter mais de um clube?</h3><p>Sim. O mesmo Player pode ter vínculos com equipes e modalidades diferentes sem misturar os dados internos dos clubes.</p></article>
          <article><h3>Se eu trocar de clube, perco o perfil?</h3><p>Não. O Player pertence ao atleta e acompanha sua trajetória.</p></article>
        </div>
      </section>

      <section className="player-test-landing">
        <span className="page-eyebrow">TESTE AGORA</span>
        <h2>Crie um Player e veja como funciona na prática.</h2>
        <p>Comece no plano Free, publique o perfil e, se o atleta já estiver cadastrado por um clube ONZEUP, teste também a busca e solicitação de vínculo.</p>
        <div className="product-landing-actions"><Link className="btn" href="/cadastro">Criar Player grátis</Link><Link className="players-secondary-cta" href="/login">Já tenho conta →</Link></div>
      </section>
