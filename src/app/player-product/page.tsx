    ...
    <main className="product-landing player-product-landing">
      ...
      <section className="product-landing-hero player-landing-with-model">
        <div>
          ...
          <div className="product-landing-actions"><Link className="btn" href="/cadastro">Criar ONZEUP Player grátis</Link><a className="players-secondary-cta" href="https://players.onzeup.com.br/gustavo-aguiar">Ver Gustavo G9 no Premium →</a></div>
