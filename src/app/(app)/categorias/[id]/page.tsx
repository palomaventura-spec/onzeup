...
export default async function CategoryHubPage({
  ...
  return (
    <>
      <div
        className="page-head category-hub-head category-premium-detail-head"
        style={{ "--category-accent": category.accentColor } as CSSProperties}
      >
        <div>
      ...
      <div className="category-hub-stats">
        ...
        <div>
          <strong>{category.trainingSchedules.length}</strong>
          <span>Treinos</span>
        </div>
        <div>
          <strong>{category.matches.length}</strong>
      ...
      <div className="category-hub-layout">
        <section className="card">
          ...
          {!category.athletes.length ? (
            <div className="empty compact-empty">Nenhum atleta ativo.</div>
          ) : null}
        </section>
        ...
        <section className="card">
          <div className="section-title-row">
            <div>
              <span className="page-eyebrow">COMISSÃO</span>
        ...
        <section className="card">
          <div className="section-title-row">
            <div>
              <span className="page-eyebrow">ROTINA</span>
              <h2>Treinos</h2>
            </div>
        ...
        <section className="card">
          <div className="section-title-row">
            <div>
              <span className="page-eyebrow">COMPETIÇÃO</span>
      ...
      <section className="card" style={{ marginTop: 18 }}>
        <div className="section-title-row">
          <div>
            <span className="page-eyebrow">CONFIGURAÇÃO</span>
        ...
        <form className="form" action={updateCategory}>
          ...
          <label>
            ...
            <input
              name="birthYear"
              type="number"
              defaultValue={category.birthYear ?? ""}
            />
          </label>
          <label>
            Descrição
          ...
          <label>
            Status
            <select name="active" defaultValue={String(category.active)}>
