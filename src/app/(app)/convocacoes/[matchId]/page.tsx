    ...
    <>
      ...
      {!canManage ? (
        ...
        >
          ...
          {" — "}
          você pode consultar a convocação,
          mas não alterá-la.
        </div>
      ) : null}
      ...
      <div className="two-col">
        <section className="card">
          ...
          {!canManage ? (
            ...
            <div className="empty">
              Todos os atletas ativos desta
              categoria já foram adicionados.
            </div>
          ) : (
            <form
              className="form"
              action={createCallUps}
            >
              <input
                type="hidden"
                name="matchId"
          ...
          <div className="private-note">
            Esta lista é privada e não aparece
            no site público da organização.
          </div>
        </section>
