...
export default function ClubLanding() {
  return <main className="club-commercial-home club-complete-landing">
    <header className="club-commercial-nav">
      <Link href="/club" className="marketing-brand">11<span>UP</span> <b>CLUB</b></Link>
    ...
    <section className="club-commercial-hero">
      ...
      <aside className="club-commercial-dashboard"><span>11UP CLUB</span><h3>O que precisa da sua atenção hoje.</h3><div><article><strong>8</strong><small>Categorias</small></article><article><strong>186</strong><small>Atletas</small></article><article><strong>4</strong><small>Jogos</small></article></div><section><small>PRÓXIMO JOGO</small><b>Sub-9 × Academia Futuro</b><span>Sábado • 10:30 • 18 convocados</span></section></aside>
    </section>

    <section className="club-problem-strip"><div><strong>Planilhas</strong><span>espalhadas</span></div><i>→</i><div><strong>WhatsApp</strong><span>sem histórico</span></div><i>→</i><div><strong>Cobranças</strong><span>manuais</span></div><i>→</i><div className="solution"><strong>11UP</strong><span>tudo conectado</span></div></section>
    ...
    <section className="club-ecosystem-section" id="conectado">
      <div><span className="page-eyebrow">CLUB + PLAYER + COACH</span><h2>O clube administra. Cada pessoa mantém sua própria identidade.</h2><p>Famílias usam o 11UP Player. Treinadores usam o 11UP Coach. O Club conecta esses perfis por vínculo e permissão, sem compartilhar senhas.</p></div>
    ...
    <section className="onze-testimonials light">
      ...
      <div className="onze-testimonial-grid">
        <article className="onze-testimonial-card">
          <small>11UP CLUB</small>
          <blockquote>“Sou treinador e gestor de uma escolinha de futebol, e o 11UP facilitou muito a minha organização. Além de ter um site profissional e editável, posso vincular treinadores e alunos e concentrar tudo em um único sistema.”</blockquote>
          <strong>Julio</strong><span>Treinador e Gestor de Escolinha de Futebol</span>
        </article>
      </div>
    </section>

    <section className="club-commercial-section" id="planos"><span className="marketing-kicker dark">PLANOS 11UP CLUB</span><h2>Comece pequeno.<br/>Cresça sem trocar de sistema.</h2><p className="club-plan-note">Os planos comerciais estão sendo ajustados para atender desde treinamentos e pequenas escolinhas até operações maiores. O acesso inicial pode ser liberado pela equipe 11UP.</p><div className="club-plan-preview"><article><small>ENTRADA</small><h3>Pequenas operações</h3><p>Organize a rotina e profissionalize a gestão.</p></article><article className="featured"><small>CRESCIMENTO</small><h3>Base em expansão</h3><p>Mais atletas, categorias e recursos conectados.</p></article><article><small>ESTRUTURA</small><h3>Operações maiores</h3><p>Escala, personalização e suporte ao volume.</p></article></div><Link className="marketing-cta" href="/cadastro-clube">Criar meu clube</Link></section>

    <section className="club-commercial-section dark" id="faq-club"><span className="marketing-kicker">PERGUNTAS FREQUENTES</span><h2>Antes de começar.</h2><div className="club-faq"><article><h3>Serve para escolinha pequena?</h3><p>Sim. Clubes, escolinhas, CTs, projetos e treinamentos personalizados podem usar a plataforma.</p></article><article><h3>O treinador usa a senha do clube?</h3><p>Não. Ele usa o próprio 11UP Coach e recebe somente as permissões da equipe vinculada.</p></article><article><h3>O atleta precisa ter Player?</h3><p>Não para o clube cadastrá-lo. Se a família criar o Player, pode solicitar o vínculo usando o mesmo e-mail informado ao clube.</p></article><article><h3>O site público dá trabalho extra?</h3><p>Não. Os dados do painel podem alimentar a página pública automaticamente.</p></article></div></section>

    <section className="club-final-cta"><span>COMECE COM SUA ROTINA REAL</span><h2>Crie seu 11UP Club<br/>e convide sua equipe.</h2><p>Cadastre sua organização, monte sua base e centralize a rotina do clube.</p><Link className="btn" href="/cadastro-clube">Criar meu clube</Link></section>
  </main>;
}
