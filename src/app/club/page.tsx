...
export default function ClubLanding() {
  return <main className="club-commercial-home club-complete-landing">
    ...
    <section className="club-final-cta"><span>COMECE COM SUA ROTINA REAL</span><h2>Crie seu ONZEUP Club<br/>e convide sua equipe.</h2><p>Cadastre sua organizaÃ§Ã£o, monte sua base e centralize a rotina do clube.</p><Link className="btn" href="/cadastro-clube">Começar 15 dias grátis</Link></section>
  </main>;
}
