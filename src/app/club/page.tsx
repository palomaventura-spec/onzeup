...
export default function ClubLanding() {
  return <main className="club-commercial-home club-complete-landing">
    ...
    <section className="club-commercial-section dark" id="como-funciona"><span className="marketing-kicker">COMECE RÁPIDO</span><h2>Cadastre. Organize. Convide.</h2><div className="club-steps"><article><b>01</b><h3>Crie sua organização</h3><p>15 dias grátis para configurar e conhecer.</p></article><article><b>02</b><h3>Monte sua base</h3><p>Categorias, atletas, comissão, treinos e jogos.</p></article><article><b>03</b><h3>Conecte famílias e comissão</h3><p>Player e Coach usam logins próprios e vínculos confirmados.</p></article></div></section>
    ...
    <section className="club-commercial-section" id="planos"><span className="marketing-kicker dark">PLANOS ONZEUP CLUB</span><h2>Comece pequeno.<br/>Cresça sem trocar de sistema.</h2><p className="club-plan-note">Os planos comerciais estão sendo ajustados para atender desde treinamentos e pequenas escolinhas até operações maiores. O perÃ­odo gratuito já está disponível.</p><div className="club-plan-preview"><article><small>ENTRADA</small><h3>Pequenas operações</h3><p>Organize a rotina e profissionalize a gestão.</p></article><article className="featured"><small>CRESCIMENTO</small><h3>Base em expansão</h3><p>Mais atletas, categorias e recursos conectados.</p></article><article><small>ESTRUTURA</small><h3>Operações maiores</h3><p>Escala, personalização e suporte ao volume.</p></article></div><Link className="marketing-cta" href="/cadastro-clube">Experimente grÃ¡tis por 15 dias</Link></section>
    ...
    <section className="club-final-cta"><span>COMECE COM SUA ROTINA REAL</span><h2>Crie seu ONZEUP Club<br/>e convide sua equipe.</h2><p>Cadastre uma categoria, alguns atletas e um treinador para experimentar o fluxo completo.</p><Link className="btn" href="/cadastro-clube">Começar 15 dias grátis</Link></section>
  </main>;
}
