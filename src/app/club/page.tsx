...
export default function ClubLanding() {
  return <main className="club-commercial-home club-complete-landing">
    ...
    <section className="club-commercial-hero">
      <div><span className="marketing-kicker">CLUBES • ESCOLINHAS • CTs • PROJETOS</span><h1>MENOS IMPROVISO.<br/><em>MAIS GESTÃO.</em></h1><p>Gestão esportiva, comunicação, cobranças e site público em uma plataforma feita para a rotina da base.</p><div className="marketing-actions"><Link className="marketing-cta" href="/cadastro-clube">Começar 15 dias grátis</Link><a className="marketing-ghost" href="#recursos">Conhecer recursos ↓</a></div><small>Sem cartão no cadastro inicial.</small></div>
    ...
    <section className="club-ecosystem-section" id="conectado">
      ...
      <div className="club-ecosystem-grid"><article><strong>PLAYER</strong><h3>Atletas vinculados</h3><p>O responsável usa o mesmo e-mail informado ao clube, solicita a correspondência e a equipe confirma.</p></article><article><strong>COACH</strong><h3>Comissão com acesso próprio</h3><p>O clube convida o Coach e define categoria, modalidade, elenco, agenda e convocação.</p></article><article><strong>CLUB</strong><h3>Controle continua com a organização</h3><p>Dados internos, financeiro e outras categorias permanecem isolados por permissão.</p></article></div>
    </section>

    <section className="coach-permissions-landing club-coach-permission"><div><span className="page-eyebrow">COMISSÃO TÉCNICA</span><h2>Sem senha compartilhada.</h2><p>Vincule treinadores pelo e-mail da conta ONZEUP Coach. O profissional aceita o convite e acessa somente o contexto autorizado.</p></div><div className="coach-permission-grid"><article><strong>Elenco</strong><span>da categoria vinculada</span></article><article><strong>Agenda</strong><span>da equipe</span></article><article><strong>Convocação</strong><span>visualizar ou gerenciar</span></article><article><strong>Financeiro</strong><span>não liberado por padrão</span></article></div></section>

    <section className="club-commercial-section dark" id="como-funciona"><span className="marketing-kicker">COMECE RÁPIDO</span><h2>Cadastre. Organize. Convide.</h2><div className="club-steps"><article><b>01</b><h3>Crie sua organização</h3><p>15 dias grátis para configurar e testar.</p></article><article><b>02</b><h3>Monte sua base</h3><p>Categorias, atletas, comissão, treinos e jogos.</p></article><article><b>03</b><h3>Conecte famílias e comissão</h3><p>Player e Coach usam logins próprios e vínculos confirmados.</p></article></div></section>
    ...
    <section className="club-commercial-section" id="planos"><span className="marketing-kicker dark">PLANOS ONZEUP CLUB</span><h2>Comece pequeno.<br/>Cresça sem trocar de sistema.</h2><p className="club-plan-note">Os planos comerciais estão sendo ajustados para atender desde treinamentos e pequenas escolinhas até operações maiores. O teste gratuito já está disponível.</p><div className="club-plan-preview"><article><small>ENTRADA</small><h3>Pequenas operações</h3><p>Organize a rotina e profissionalize a gestão.</p></article><article className="featured"><small>CRESCIMENTO</small><h3>Base em expansão</h3><p>Mais atletas, categorias e recursos conectados.</p></article><article><small>ESTRUTURA</small><h3>Operações maiores</h3><p>Escala, personalização e suporte ao volume.</p></article></div><Link className="marketing-cta" href="/cadastro-clube">Testar por 15 dias</Link></section>
    ...
    <section className="club-final-cta"><span>TESTE COM SUA ROTINA REAL</span><h2>Crie seu ONZEUP Club<br/>e convide sua equipe.</h2><p>Cadastre uma categoria, alguns atletas e um treinador para experimentar o fluxo completo.</p><Link className="btn" href="/cadastro-clube">Começar 15 dias grátis</Link></section>
  </main>;
}
