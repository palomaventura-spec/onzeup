  ...
  return (
    <main className="qtr-print-page">
      <style>{`
        ...
        .qtr-print-table th:first-child{
          text-align:left;
          width:150px
        }
      ...
      <header className="qtr-print-header">
        <div>
          <div className="qtr-print-identity">
            {org.logoUrl ? (
              <img
                className="qtr-print-logo"
                src={org.logoUrl}
                alt=""
              />
            ) : null}

            <div className="qtr-print-club-name">
              {org.publicName ||
                org.name}
            </div>
          </div>
