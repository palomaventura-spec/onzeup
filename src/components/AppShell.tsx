...
const groups = [
  { title: "GESTÃO", items: [["/dashboard","Dashboard"],["/agenda","Agenda"],["/categorias","Categorias"],["/comissao","Comissão"],["/atletas","Atletas"]] },
  { title: "FUTEBOL", items: [["/treinos","Treinos"],["/jogos","Jogos"],["/qtr","QTR"]] },
  { title: "RELACIONAMENTO", items: [["/comunicacao","Comunicação"],["/vinculos-player","Vínculos Player"]] },
  { title: "ADMINISTRAÇÃO", items: [["/financeiro","Financeiro"],["/organizacao","Site e Configurações"],["/planos","Plano e assinatura"],["/integracoes","Integrações"],["/ajuda","Ajuda"]] },
] as const;
